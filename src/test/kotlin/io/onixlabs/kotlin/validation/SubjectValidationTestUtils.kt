...
internal object SubjectValidationTestUtils {
    ...
    fun loadExpectedComplexSubjectGraph(): String {
        val classLoader = ClassLoader.getSystemClassLoader()
        val file = File(classLoader.getResource("complex-subject-validator.graph.min.json")!!.file)
        return file.readText()
    }

    fun loadExpectedNullSubjectGraph(): String {
        val classLoader = ClassLoader.getSystemClassLoader()
        val file = File(classLoader.getResource("null-subject-validator.graph.min.json")!!.file)
        return file.readText()
    }
